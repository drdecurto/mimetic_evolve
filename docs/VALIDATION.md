...
- all Python scripts compile with `py_compile`;
...
- the GitHub release intentionally excludes journal manuscript sources and compiled PDFs; those are distributed as a separate submission package;
...
- the authoritative downstream tables report the interior transient maximum and weighted-symmetry contrast;
